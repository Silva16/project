<div class="container">
    ...
    <div class="form-group @if ($errors->has('id')) has-error @endif">
        ...
        {!! Form::select('id', array('default' => 'Seleccione uma opção') + $institutions, 'default', array('class' =>
        'form-control')) !!}
        @if ($errors->has('id'))
            <span class="alert alert-danger">
        {{ $errors->first('id') }}
    ...
    <div class="form-group @if ($errors->has('role')) has-error @endif">
        ...
        {!! Form::select('role', array('default' => 'Seleccione uma opção') + $roles, 'default', array('class' =>
        'form-control')) !!}
        @if ($errors->has('role'))
            <span class="alert alert-danger">
        {{ $errors->first('role') }}
