...
class Swift_Signers_DKIMSignerTest extends \SwiftMailerTestCase
{
    ...
    public function testBasicSigningHeaderManipulation()
    {
        ...
        $signer = new Swift_Signers_DKIMSigner(file_get_contents(dirname(dirname(dirname(__DIR__))) . '/_samples/dkim/dkim.test.priv'),
            'dummy.nxdomain.be', 'dummySelector');
    ...
    public function testSigningDefaults()
    {
        ...
        $sig = reset($dkim);
        $this->assertEquals($sig->getValue(),
    ...
    private function _createHeaderSet()
    {
        ...
        $headers = new Swift_Mime_SimpleHeaderSet(new Swift_Mime_SimpleHeaderFactory($headerEncoder, $paramEncoder,
            $grammar));
