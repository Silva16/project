...
class SubjectSpec extends ObjectBehavior
{
    ...
    function it_passes_the_created_subject_to_expectation(
        WrappedObject $wrappedObject,
        ExpectationFactory $expectationFactory,
        ...
        $expectationFactory->create(Argument::any(), Argument::type('spec\PhpSpec\Wrapper\Everything'),
            Argument::any())->shouldHaveBeenCalled();
    }

    function it_passes_the_existing_subject_to_expectation(
        Wrapper $wrapper,
        WrappedObject $wrappedObject,
        Caller $caller,
        SubjectWithArrayAccess $arrayAccess,
        ...
        $this->beConstructedWith($existingSubject, $wrapper, $wrappedObject, $caller, $arrayAccess,
            $expectationFactory);
        ...
        $this->callOnWrappedObject('shouldBeAlright');
        $expectationFactory->create(Argument::any(), Argument::exact($existingSubject),
            Argument::any())->shouldHaveBeenCalled();
    }
}
