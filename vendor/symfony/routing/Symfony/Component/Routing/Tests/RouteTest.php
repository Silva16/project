...
class RouteTest extends \PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        ...
        $this->assertEquals(array('foo' => 'bar'), $route->getDefaults(),
            '__construct() takes defaults as its second argument');
        $this->assertEquals(array('foo' => '\d+'), $route->getRequirements(),
        ...
        $this->assertEquals(array('POST', 'PUT'), $route->getMethods(),
    ...
    public function testDefaults()
    {
        ...
        $this->assertEquals(array('foo' => 'foo', 'bar' => 'bar'), $route->getDefaults(),
    ...
    public function testRequirements()
    {
        ...
        $this->assertEquals($route, $route->setRequirements(array()),
            '->setRequirements() implements a fluent interface');

        $route->setRequirements(array('foo' => '\d+'));
        $route->addRequirements(array('bar' => '\d+'));
        $this->assertEquals($route, $route->addRequirements(array()),
            '->addRequirements() implements a fluent interface');
        $this->assertEquals(array('foo' => '\d+', 'bar' => '\d+'), $route->getRequirements(),
    ...
    public function testScheme()
    {
        ...
        $this->assertEquals(array('http'), $route->getSchemes(),
        ...
        $this->assertEquals(array('https', 'http'), $route->getSchemes(),
    ...
    {
        $route = new Route('/{foo}');
        $this->assertInstanceOf('Symfony\Component\Routing\CompiledRoute', $compiled = $route->compile(),
