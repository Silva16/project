...
class XliffFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEncoding()
    {
        ...
        $this->assertEquals(array('notes' => array(array('content' => utf8_decode('bäz')))),
    ...
    public function testParseEmptyFile()
    {
        ...
        $this->setExpectedException('Symfony\Component\Translation\Exception\InvalidResourceException',
    ...
    public function testLoadNotes()
    {
        ...
        $this->assertEquals(array('notes' => array(array('priority' => 1, 'content' => 'foo'))),
            $catalogue->getMetadata('foo', 'domain1'));
