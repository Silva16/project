...
class UserAuthenticationProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAuthenticate()
    {
        ...
        $this->assertEquals(array('foo' => 'bar'), $authToken->getAttributes(),
            '->authenticate() copies token attributes');
    }
    ...
    public function testAuthenticateWithPreservingRoleSwitchUserRole()
    {
        ...
        $switchUserRole = new SwitchUserRole('foo',
    ...
    {
        $mock = $this->getMock('Symfony\Component\Security\Core\Authentication\Token\UsernamePasswordToken',
            array('getCredentials', 'getProviderKey', 'getRoles'), array(), '', false);
        $mock
            ->expects($this->any())
    ...
    protected function getProvider($userChecker = false, $hide = true)
    {
        ...
        return $this->getMockForAbstractClass('Symfony\Component\Security\Core\Authentication\Provider\UserAuthenticationProvider',
            array($userChecker, 'key', $hide));
    }
}
